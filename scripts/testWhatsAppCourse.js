...
Invoice.findOne=async()=>({...saved,status:'paid',amount:10000});r=res();await c.getInvoice({params:{token:saved.token}},r);assert.equal(r.data.contactUrl,'https://wa.me/2348143017102?text=I%20just%20paid');assert.equal(r.data.courses,undefined);
