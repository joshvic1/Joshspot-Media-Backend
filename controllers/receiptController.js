...
exports.sendReceipt = async (req,res) => {
  ...
  try {
    ...
    },{$set:{receiptClaimedAt:now,customerEmail:email}},{new:true});
    ...
    return res.status(502).json({message:'Receipt could not be sent. Any email you entered has been saved; please retry.'});
  }
};
